...
const MIGRATIONS = {
  ...
  // 6 -> 7: pallets. A new object kind, independent of rack rows/bin types —
  // just a positioned box with its own w/d/h, drawn with a wood-pallet look
  // (deck slats + support blocks). Seeded empty; no rendering change until
  // the user places one.
  6: (v6) => ({
    ...v6,
    pallets: v6.pallets ?? [],

...
// Moulins-catalog cross-links (categories, "explore more", recently viewed,
// portfolio) since special products are a private, uncategorised catalog.
export default function SpecialProductDetailPage() {
  ...
  const priceValue = product.mrp ?? product.price;
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <button
        ...
        className="flex items-center gap-2 text-sm text-gray-400 hover:text-gray-900 transition mb-10"
      >
        ...
        <div>
          ...
          {priceValue != null && (
            <p className="text-2xl font-light text-gray-900 mb-4">
              MRP Rs. {parseFloat(priceValue).toFixed(2)}
            </p>
          )}

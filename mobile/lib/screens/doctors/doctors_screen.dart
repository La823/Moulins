...
class _DoctorsScreenState extends ConsumerState<DoctorsScreen> {
  ...
  void _showDoctorForm({Doctor? existing}) {
    ...
    final specialityCtrl =
        TextEditingController(text: existing?.speciality ?? '');
    ...
    PickedLocation? location = existing != null &&
            existing.latitude != null &&
            existing.longitude != null
        ? PickedLocation(
            lat: existing.latitude!,
            lng: existing.longitude!,
            address: existing.clinicAddress)
        : null;
          ...
          children: [
            ...
            Flexible(
              child: Text(
                ...
                style:
                    const TextStyle(fontSize: 12.5, color: Color(0xFF1A1A1A)),
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.calendar_today_outlined,
                color: Color(0xFF00A6A4), size: 20),
            tooltip: 'My Meetings',
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          label: const Text('Add Doctor',
                              style: TextStyle(color: Color(0xFF00A6A4))),
                          onPressed: _showAddDialog,
                        ),
                      ],
                    ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _fieldRow(
                                      'Birthday',
                                      d.dob != null
                                          ? '${d.dob!.day}/${d.dob!.month}'
                                          : null),
                                  _fieldRow(
                                      'Anniversary',
                                      d.anniversary != null
                                          ? '${d.anniversary!.day}/${d.anniversary!.month}'
                                          : null),
                                  _fieldRow('Clinic',
